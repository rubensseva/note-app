...
export class Cards extends Component {
  ...
  handleAddCardDialogSubmit() {
    ...
    this.props.addCard(this.state.dialogName, this.state.dialogQuestion, this.state.dialogAnswer)
  }
    ...
    return (
      <div>
        ...
        >
          ...
          <DialogActions>
            <Button onClick={this.handleAddCardDialogSubmit}>
              submit
            </Button>
          </DialogActions>
        </Dialog>
...
export default connect(mapStateToProps, { addCard })(Cards);
